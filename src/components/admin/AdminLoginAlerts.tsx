  ...
  return (
    <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 px-3 py-3 text-sm text-amber-900 dark:border-amber-900 dark:bg-amber-950/40 dark:text-amber-100">
      ...
      <p className="mt-1 text-amber-800 dark:text-amber-200">
        Your account is signed in but its email is not listed in{" "}
        <code className="font-mono text-xs">ADMIN_ALLOWED_EMAILS</code>. Ask a project
        owner to add your address, or sign out and use an allowed account.
      </p>
      <Button
        type="button"
        variant="outline"
